...
class Product(models.Model):
    ...
    def max_fee(self):
        ...
        try:
            if self.sep < 85.70:
                return self.sep + (self.sep * 0.46 + 6.95) * VAT
            elif self.sep < 228.53:
                return self.sep + (self.sep * 0.33 + 18.55) * VAT
            elif self.sep < 799.85:
                return self.sep + (self.sep * 0.15 + 59) * VAT
            else:
